...
export default function Home() {
  ...
  return (
    <>
      ...
      <section
        id="works"
        className="relative py-6 sm:py-4 lg:py-16 xl:py-20 z-50 bg-transparent 2xl:py-24 -mt-40 -mb-32 scroll-smooth overflow-hidden"
      >
      ...
      <section
        id="monthly-views-overview"
        className="relative py-16 sm:py-20 lg:py-24 bg-dot-blue-700/[0.5] bg-black scroll-smooth overflow-hidden mt-20"
      >
        <RevealOnScroll>
      ...
      <section
        ...
        id="connect-section"
        className="relative py-16 sm:py-20 lg:py-24 bg-black scroll-smooth overflow-hidden mt-20"
      >
        <RevealOnScroll>
      ...
      <section className="relative py-16 sm:py-20 lg:py-24 bg-black scroll-smooth overflow-hidden mt-20 -mb-32">
        <div className="max-w-7xl mx-auto px-4 z-50 bg-transparent scroll-smooth relative">
          <RevealOnScroll>
            <FeaturesSectionDemo />
          </RevealOnScroll>
