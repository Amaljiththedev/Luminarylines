  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        {/* New Luminary School Button */}
        <Link
          href="/school" // Update with the actual link to Luminary School page
          className="flex items-center justify-center h-10 rounded-full border text-white px-4 font-medium transition-colors hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-slate-50"
        >
          Luminary School
        </Link>
        <button className="">
